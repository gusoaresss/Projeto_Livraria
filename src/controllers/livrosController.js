...
function graficoQtdLivrosCategoria(req, res){
    livrosModel.graficoQtdLivrosCategoria().then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
...
function generoComMaiorQuantidade(req, res){
     livrosModel.generoComMaiorQuantidade().then(function (resultado) {
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
            res.status(204).send("Nenhum resultado encontrado!")
